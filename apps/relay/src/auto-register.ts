...
/** Hardcoded relay stake: 1 DVCONF = 1_000_000_000 MIST (per constants.move DEFAULT_RELAY_THRESHOLD). */
const RELAY_STAKE = 1_000_000_000n;
...
export async function ensureRegistered(
  ...
  // Step 1: Register as a miner with role=Relay (1 DVCONF stake)
