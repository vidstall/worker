/**
 * F1 / REQ-RO-001/002/008/009 — PrimaryPipeCoordinator unit tests: mint
 * orchestration for both arrival orders (params-first / producer-first),
 * mint-once + multi-producer drain + clear, and the REQ-RMS-029 original
 * producerPeerId on the cascade announce.
 */
