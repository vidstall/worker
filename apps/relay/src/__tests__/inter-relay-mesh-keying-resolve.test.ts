/**
 * REQ-RMS-008/029 unit tests — the mesh registry keyed per (roomId,
 * peerRelayId), resolveByProducerId cross-bucket lookup,
 * StandbyWarmPipeCoordinator.currentPipeConsumer per-(room,peer)
 * disambiguation, and createInterRelayAnnouncer forwarding peerRelayId into
 * the announce frame.
