...
**Run ID:** 2026-07-22T06-55-15-657Z  
**Timestamp (UTC):** 2026-07-22T06:55:38.338Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-07-22T06-55-15-657Z.jsonl`  
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 54.0 | - | - |
| **P95 MTTR** | **56.0** | <= 100 | yes |
| **P99 MTTR** | **59.0** | <= 200 | yes |
| mean | 53.9 | - | - |
| min / max | 52.0 / 59.0 | - | - |
| failed runs | 0 | 0 | yes |
...
| relay + resume (watcher fired -> first standby RTP) | 3.0 | 5.0 |
