...
**Run ID:** 2026-08-10T17-30-04-019Z  
**Timestamp (UTC):** 2026-08-10T17:30:26.794Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-08-10T17-30-04-019Z.jsonl`  
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 57.0 | - | - |
| **P95 MTTR** | **61.0** | <= 100 | yes |
| **P99 MTTR** | **65.0** | <= 200 | yes |
| mean | 56.9 | - | - |
| min / max | 50.0 / 65.0 | - | - |
| failed runs | 0 | 0 | yes |
...
|---|---:|---:|
| detection window (kill -> watcher fired) | 51.0 | 52.0 |
