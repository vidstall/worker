...
**Run ID:** 2026-08-03T08-13-24-787Z  
**Timestamp (UTC):** 2026-08-03T08:13:47.708Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-08-03T08-13-24-787Z.jsonl`  
**Verdict:** **PASS** vs N >= 30, failures = 0, P95 <= 100 ms / P99 <= 200 ms
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 54.0 | - | - |
| **P95 MTTR** | **63.0** | <= 100 | yes |
| **P99 MTTR** | **107.0** | <= 200 | yes |
| mean | 55.9 | - | - |
| min / max | 51.0 / 107.0 | - | - |
| failed runs | 0 | 0 | yes |
...
|---|---:|---:|
| detection window (kill -> watcher fired) | 51.0 | 53.0 |
| relay + resume (watcher fired -> first standby RTP) | 3.0 | 10.0 |
