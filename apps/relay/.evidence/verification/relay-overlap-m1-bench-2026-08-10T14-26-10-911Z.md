...
**Run ID:** 2026-08-10T14-26-10-911Z  
**Timestamp (UTC):** 2026-08-10T14:26:33.624Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-08-10T14-26-10-911Z.jsonl`  
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 53.0 | - | - |
| **P95 MTTR** | **59.0** | <= 100 | yes |
| **P99 MTTR** | **64.0** | <= 200 | yes |
| mean | 53.7 | - | - |
| min / max | 51.0 / 64.0 | - | - |
| failed runs | 0 | 0 | yes |
...
| relay + resume (watcher fired -> first standby RTP) | 2.0 | 9.0 |
