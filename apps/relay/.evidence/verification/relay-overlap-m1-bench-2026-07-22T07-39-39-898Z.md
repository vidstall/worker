...
**Run ID:** 2026-07-22T07-39-39-898Z  
**Timestamp (UTC):** 2026-07-22T07:40:02.613Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-07-22T07-39-39-898Z.jsonl`  
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 53.0 | - | - |
| **P95 MTTR** | **57.0** | <= 100 | yes |
| **P99 MTTR** | **57.0** | <= 200 | yes |
| mean | 53.6 | - | - |
| min / max | 51.0 / 57.0 | - | - |
| failed runs | 0 | 0 | yes |
...
| relay + resume (watcher fired -> first standby RTP) | 3.0 | 6.0 |
