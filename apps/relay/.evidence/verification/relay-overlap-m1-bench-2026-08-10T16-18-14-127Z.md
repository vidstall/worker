...
**Run ID:** 2026-08-10T16-18-14-127Z  
**Timestamp (UTC):** 2026-08-10T16:18:36.896Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-08-10T16-18-14-127Z.jsonl`  
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 54.0 | - | - |
| **P95 MTTR** | **64.0** | <= 100 | yes |
| **P99 MTTR** | **67.0** | <= 200 | yes |
| mean | 55.2 | - | - |
| min / max | 52.0 / 67.0 | - | - |
| failed runs | 0 | 0 | yes |
...
| relay + resume (watcher fired -> first standby RTP) | 4.0 | 9.0 |
