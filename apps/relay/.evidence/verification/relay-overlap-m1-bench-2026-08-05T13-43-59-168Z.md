...
**Run ID:** 2026-08-05T13-43-59-168Z  
**Timestamp (UTC):** 2026-08-05T13:44:21.990Z  
**Bench commit:** unknown  
**Raw JSONL:** `/Users/qvanle/projects/personal/thesis/v3.0.0/services/worker/apps/relay/.logs/bench/adhoc-client-2026-08-05T13-43-59-168Z.jsonl`  
...
| N (runs) | 30 | >=30 | yes |
| P50 MTTR | 56.0 | - | - |
| **P95 MTTR** | **62.0** | <= 100 | yes |
| **P99 MTTR** | **63.0** | <= 200 | yes |
| mean | 56.5 | - | - |
| min / max | 50.0 / 63.0 | - | - |
| failed runs | 0 | 0 | yes |
...
| relay + resume (watcher fired -> first standby RTP) | 6.0 | 11.0 |
